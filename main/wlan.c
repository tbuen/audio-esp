...
void wlan_init(void) {
    ...
    msg_handle = msg_register(MSG_BUTTON|MSG_WLAN_INTERNAL);
    ...
    if (event_base == WIFI_EVENT) {
        switch (event_id) {
            case WIFI_EVENT_STA_START:
                msg_send_value(MSG_WLAN_INTERNAL, WIFI_EVENT_STA_START);
                break;
...
static void wlan_scan(void) {
    ...
    msg_send_value(MSG_WLAN_STATUS, WLAN_SCAN_STARTED);
    ...
    msg_send_value(MSG_WLAN_STATUS, WLAN_SCAN_FINISHED);
}
...
static void wlan_task(void *param) {
    ...
    for (;;) {
        ...
        } else if (msg.type == MSG_WLAN_INTERNAL) {
            switch (msg.value) {
                case WIFI_EVENT_STA_START:
                    wlan_scan();
                    break;
